...
const LoginForm = () => {
  ...
  return (
    ...
    <div className='px-4 sm:px-8 py-8'>
        ...
        <div className='flex flex-col items-start my-4 py-4'>
            <button onClick={authenticate} className='rounded text-white font-semibold bg-green-400 hover:bg-green-700 py-2 px-4'>Login</button>
        </div>
    </div>
</div>
